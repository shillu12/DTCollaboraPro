...
public class UserProfileController {
	...
	public ResponseEntity<UserProfile> createUserProfile(@RequestBody UserProfile userprofile)
	{
		...
		else
		{
			...
			int userProfile=userprofile.getUseridentity();
			switch(userProfile){
				case 1: userprofile.setCurrentrole("Role_Student");break;
				case 2: userprofile.setCurrentrole("Role_Alumini");break;
				case 3: userprofile.setCurrentrole("Role_External");break;
			}
